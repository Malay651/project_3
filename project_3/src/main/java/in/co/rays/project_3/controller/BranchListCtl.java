...
@WebServlet(name = "BranchListCtl", urlPatterns = { "/ctl/BranchListCtl" })
public class BranchListCtl extends BaseCtl {
...
protected void doGet(HttpServletRequest request, HttpServletResponse response)
	...
	log.debug("BranchListCtl doGet Start");
	...
	try {
		...
		System.out.println("Data in branch " + list.size());
...
protected void doPost(HttpServletRequest request, HttpServletResponse response)
	...
	log.debug("BranchListCtl doPost Start");
	...
	try {
		...
		if (OP_SEARCH.equalsIgnoreCase(op)
			...
			if (ids != null && ids.length > 0) {
				...
				for (String id : ids) {
					BranchDTO deleteDto = new BranchDTO();
