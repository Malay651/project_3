...
public class ContactListCtl extends BaseCtl {
	...
	protected BaseDTO populateDTO(HttpServletRequest request) {
		...
		dto.setFirstName(DataUtility.getString(request.getParameter("Name")));

		dto.setLastName(DataUtility.getString(request.getParameter("email")));

		dto.setLogin(DataUtility.getString(request.getParameter("mobileNo")));
		dto.setRoleId(DataUtility.getLong(request.getParameter("message")));
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			for (ContactDTO udto1 : a) {
				System.out.println(udto1.getId() + "[[[[[[[[[[[--------------------");
			}
...
// get the selected checkbox ids array for delete list
		...
		try {
			...
			System.out.println("y yyyyyyyyyy" + dto.getId());
