					...
					<div class="card">
						<div class="card-body">
							...
							<div class="md-form">
								...
								<span class="pl-sm-5"><b>ProductAmount</b><span
									style="color: red;">*</span></span> </br>
								<div class="col-sm-12">
									<div class="input-group">
										<div class="input-group-prepend">
										...
										<input type="text" name="productAmount" class="form-control"
											placeholder="Enter Address"
											value="<%=DataUtility.getStringData(dto.getProductAmount())%>">
									</div>
								</div>
								<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("productAmount", request)%></font></br>
