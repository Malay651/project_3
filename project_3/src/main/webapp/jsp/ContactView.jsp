					...
					<div class="card input-group-addon">
						<div class="card-body">
							...
							<%
								...
								if (dto.getName() != null) {
							%>
							<h3 class="text-center default-text text-primar">Update Contact</h3>
							<%
								} else {
							%>
							<h3 class="text-center default-text text-primary">Add Contact</h3>
							<%
								}
							%>
							<!--Body-->
							...
							<div class="md-form">
								...
								<div class="col-sm-12">
									<div class="input-group">
										<div class="input-group-prepend">
											<div class="input-group-text">
												<i class="fa fa-envelope grey-text"
													style="font-size: 1rem;"></i>
											</div>
										</div>
										<input type="text" class="form-control" 
											maxlength="10" name="message" placeholder="message"
								...
								<div class="text-center">
									...
									style="font-size: 17px" value="<%=ContactCtl.OP_UPDATE%>"> 
								...
								<div class="text-center">
									...
									<input type="submit" name="operation" class="btn btn-success btn-md"
									 style="font-size: 17px" value="<%=ContactCtl.OP_SAVE%>"> 
									<input type="submit" name="operation" class="btn btn-warning btn-md"
